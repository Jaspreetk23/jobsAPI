  ...
  },
  {
    ...
    params: {
      ...
      advanced_title_filter:
        "Software Developer | Software Engineer | Web Developer | App Developer",
...
async function callApiService(service) {
  ...
  try {
    ...
    // Normalize jobs
    const jobs = Array.isArray(jobsRaw) ? jobsRaw.map(service.normalize) : [];
...
app.get("/combined-jobs", async (req, res) => {
  try {
    ...
    const combinedJobs = results.reduce(
